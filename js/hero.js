(function () {
  ...
  (function scrollReveal() {
    ...
    const sections = ["sec1", "sec2", "sec3", "sec4", "sec42", "sec5", "sec6"]
  ...
  (function licenseArc() {
    ...
    // rendered px/s for the vertical scroll. Phones get a much slower pace so the
    ...
    function frame(now) {
      ...
      lastT = now;
      if (vUnit > 0) scroll = mod(scroll + (speedPx / vUnit) * dt, LOOP);
      layout(scroll);
